...
const Projects = () => {
  ...
  const projects = [
    { icon: `fa-solid fa-earth-europe`, title: "atomland.xyz", description: "Atom Gamer Arda A.G.A İle herşeyi Orada Bulabilirsiniz.", url: "https://aixe.dev/" },
  ]
      ...
      <div className='sm:ml-32'>
        <div className='mx-auto max-w-4xl px-8 sm:px-0'>
          ...
          <motion.div initial={{ opacity: 0, translateY: 30 }} animate={{ opacity: 1, translateY: 0 }} transition={{ delay: 0.3 }}>
            <p className='text-gray-400 mt-2'>Bu Sayfa Üzerinden çalıştığım Projelere Bakabilirsiniz..</p>
          </motion.div>
